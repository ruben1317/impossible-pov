...
export function Nav(){return <>
  <div className="topbar"><Link className="brand" href="/"><img className="brandimg" src="/icon-192.png" alt=""/><div>IMPOSSIBLE <span>POV</span></div></Link><div className="desktopNav nav"><Link href="/">Dashboard</Link><Link href="/videos/new">Create</Link><Link href="/history">History</Link><Link href="/settings">Settings</Link><Link href="/setup">Setup</Link></div></div>
